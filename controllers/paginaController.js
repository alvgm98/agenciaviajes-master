      ...
      try {
         ...
         const mailOptions = {
            ...
            text:
               ...
               "\n" +
               "Descripción: " +
               resultado2.descripcion, // Contenido del correo
         };
...
const guardarReview = async (req, res) => {
   const { titulo, descripcion, usuario, puntuacion, viajeId, viajeSlug } = req.body;

   console.log({ titulo, descripcion, usuario, puntuacion, viajeId, viajeSlug })
